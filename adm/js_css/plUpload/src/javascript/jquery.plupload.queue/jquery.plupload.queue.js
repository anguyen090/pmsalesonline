						...
						if (file.status == plupload.DONE) {
							...
							$('#' + id + '_count').val(inputCount);
                                                ...
                                                if (!file.thumb_data) {
                                                    ...
                                                    listHTML += (file.thumb_percent < 100 ? '<div class="plupload_file_thumb_progress" style="width:' + file.percentLoading + 'px;"></div>' : '<img src="data:image/gif;base64,' + file.thumb_data + '" alt="' + file.name + '" />');
                                                    listHTML += '</div>';
                                                }
